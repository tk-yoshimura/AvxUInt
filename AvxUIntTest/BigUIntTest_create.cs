...
namespace AvxUIntTest {
    ...
    public class CreateTests {
        ...
        public void CreateTest() {
            ...
            UInt32[] value3 = new UInt32[] { ~0u, ~0u, ~0u, ~0u, ~0u, ~0u };
            UInt32[] value4 = new UInt32[] { ~0u, ~0u, ~0u, ~0u - 1, ~0u, ~0u };
            ...
            BigUInt<Pow2.N4> n16 = new(Array.AsReadOnly(value3), -3, carry: true);
            BigUInt<Pow2.N4> n17 = new(Array.AsReadOnly(value3), -2, carry: false);
            BigUInt<Pow2.N4> n18 = new(Array.AsReadOnly(value4), -2, carry: true);
            ...
            CollectionAssert.AreEqual(new UInt32[] { 0u, 0u, 0u, 1u }, n16.Value);
            CollectionAssert.AreEqual(new UInt32[] { ~0u, ~0u, ~0u, ~0u }, n17.Value);
            CollectionAssert.AreEqual(new UInt32[] { 0u, ~0u, ~0u, ~0u }, n18.Value);
        }
        ...
        public void BadCreateTest() {
            ...
            UInt32[] value2 = new UInt32[] { 0x3478u, 0xFEDCu, 0x2341u, 0x6785u, 0xABC9u, 0xEF0Du };
            UInt32[] value4 = new UInt32[] { ~0u, ~0u, ~0u, ~0u };
            UInt32[] value3 = new UInt32[] { ~0u, ~0u, ~0u, ~0u, ~0u, ~0u };

            Assert.ThrowsException<OverflowException>(() => {
                BigUInt<Pow2.N4> n = new(Array.AsReadOnly(value4), 0, carry: true);
            });
            ...
            Assert.ThrowsException<OverflowException>(() => {
                BigUInt<Pow2.N4> n = new(Array.AsReadOnly(value3), -2, carry: true);
            });

            Assert.ThrowsException<ArgumentOutOfRangeException>(() => {
                BigUInt<Pow2.N4> n = new(Array.AsReadOnly(value3), -1, carry: true);
            });

            Assert.ThrowsException<ArgumentOutOfRangeException>(() => {
                BigUInt<Pow2.N4> n = new(Array.AsReadOnly(value4), 1, carry: true);
            });
        }
