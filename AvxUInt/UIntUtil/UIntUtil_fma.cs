        ...
        private static unsafe void Fma(uint offset, uint digits_a, UInt32[] arr_dst, UInt32[] arr_a, UInt32 b) {
            ...
            fixed (UInt32* va0 = arr_a, vd0 = arr_dst) {
                ...
                while (r >= MM256UInt32s * 4) {
                    ...
                    (r0, r1, r2, r3, c0, c1, c2, c3, carry)
                        = FlushCarryAddX4(r0, r1, r2, r3, c0, c1, c2, c3, carry);
                    ...
                    (d0, d1, d2, d3, c0, c1, c2, c3, carry)
                        = FlushCarryAddX4(d0, d1, d2, d3, c0, c1, c2, c3, carry);
                ...
                if (r >= MM256UInt32s * 2) {
                    ...
                    (r0, r1, c0, c1, carry)
                        = FlushCarryAddX2(r0, r1, c0, c1, carry);
                    ...
                    (d0, d1, c0, c1, carry)
                        = FlushCarryAddX2(d0, d1, c0, c1, carry);
                ...
                if (r >= MM256UInt32s) {
                    ...
                    (r0, c0, carry) = FlushCarryAdd(r0, c0, carry);

                    (d0, c0) = Add(d0, r0);

                    (c0, carry) = CarryShift(c0, carry);
                    (d0, c0, carry) = FlushCarryAdd(d0, c0, carry);
